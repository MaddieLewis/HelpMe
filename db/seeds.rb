...
Task.create!(user_id: 1, title: 'I need someone to walk my dog', description: 'My dog Neptune needs a long walk today as I am home sick', start_date: "#{Date.today}", start_time: "#{Time.now}", end_date: "#{Date.today}", end_time: "#{Time.now}", category: "pets", address: "Unit 13, 138 Kingsland Rd, London E2 8DY", photo: "https://images.unsplash.com/photo-1518587671104-999f3dd2d340?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80")
Task.create!(user_id: 2, title: 'I need someone to take me to meet Nick Cage', description: 'I LOVE NIC CAGE', start_date: "#{Date.today}", start_time: "#{Time.now}", end_date: "#{Date.today}", end_time: "#{Time.now}", category: "transport", address: "2 Drysdale St, London N1 6NA", photo: "https://financebuzz.imgix.net/images/2016/02/03/nicolascagepainting18.jpg?auto=compress&fit=crop&h=512&w=970&ixlib=python-1.0.0")
Task.create!(user_id: 2, title: 'I need someone to take care of my cat', description: 'She needs to be well looked after', start_date: "#{Date.today}", start_time: "#{Time.now}", end_date: "#{Date.today}", end_time: "#{Time.now}", category: "pets", address: "69 Drysdale St, London N1 6ND", photo: "https://images.unsplash.com/photo-1503777119540-ce54b422baff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=933&q=80")
Task.create!(user_id: 2, title: 'I need taking to the shops', description: 'For my usual Sunday grocery shopping', start_date: "#{Date.today}", start_time: "#{Time.now}", end_date: "#{Date.today}", end_time: "#{Time.now}", category: "transport", address: "178 Junction Rd, London N19 5QQ", photo: "https://images.unsplash.com/photo-1473648717346-73c9c15cbad6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=967&q=80")
