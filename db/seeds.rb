...
nic = "https://images.mentalfloss.com/sites/default/files/styles/width-constrained-728/public/84010-nicolas-cage.jpg"
...
Task.create!(user: user3, title: 'Help me shop', description: 'For my usual Sunday grocery shopping, I would love it if you could help.', start_time: "#{Time.now}", end_time: "#{Time.now + (2*7*24*60*60)}", category: "shopping", address: "178 Junction Rd, London N19 5QQ", remote_photo_url: grocerys)
...
# Task.create!(user: user1, title: 'Help me with some DIY', description: 'I just splurged at IKEA but forgot I cannot make anything by myself! Will you help me make some IKEA furniture?', start_time: "#{Time.now}", end_time: "#{Time.now + (2*7*24*60*60)}", category: "DIY", address: "138 Kingsland Rd, London E2 8DY", remote_photo_url: )
